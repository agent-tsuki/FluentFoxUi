      ...
      <div className="space-y-10">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-on-surface-variant leading-relaxed">
          <Section title="1. Acceptance of Terms">
            By accessing or using FluentFox ("the Service"), you agree to be bound by these Terms of
          ...
          <Section title="2. Use of the Service">
            FluentFox is a Japanese language learning platform. You may use the Service only for
          ...
          <Section title="4. Intellectual Property">
            ...
            educational materials, is the property of FluentFox or its content suppliers and is
          ...
          <Section title="5. User-Generated Content">
            If you submit any content to the Service, you grant FluentFox a non-exclusive, royalty-
          ...
          <Section title="6. Disclaimer of Warranties">
            ...
            of any kind, either express or implied. FluentFox does not warrant that the Service will
            be uninterrupted, error-free, or free of viruses or other harmful components.
          </Section>

          <Section title="7. Limitation of Liability">
            To the fullest extent permitted by law, FluentFox shall not be liable for any indirect,
          ...
          <Section title="9. Contact Us">
            ...
            <a href="mailto:legal@fluentfox.jp" className="text-primary hover:underline">
              legal@fluentfox.jp
            </a>
            .
          </Section>
